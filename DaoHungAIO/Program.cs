    ...
    internal class Program
    {
        ...
        private static void OnGameLoad()
        {
            try
            {
                ...
                Notifications.Add(new Notification("XDreams is just a kid stealing, disrespecting the source owner", "XDreams is just a kid stealing, disrespecting the source owner"));
